...
export default function SectionUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setFlagRegisCon(cleanValues.flagRegisCon);
    setSubjectNameTh(cleanValues.subjectNameTh);
    setSubjectNameEn(cleanValues.subjectNameEn);
    setMaxCredit(cleanValues.maxCredit);
    setSectionCode(cleanValues.sectionCode);
    setSectionType(cleanValues.sectionType);
    setSectionTypeTh(cleanValues.sectionTypeTh);
    setSectionTypeEn(cleanValues.sectionTypeEn);
    setStudentStatusCode(cleanValues.studentStatusCode);
    setStdStatusTh(cleanValues.stdStatusTh);
    setStdStatusEn(cleanValues.stdStatusEn);
    setCoursedate(cleanValues.coursedate);
    setCoursedateth(cleanValues.coursedateth);
    setCoursedateen(cleanValues.coursedateen);
    setTotalSeat(cleanValues.totalSeat);
    setTotalRegistered(cleanValues.totalRegistered);
    setTeacherName(cleanValues.teacherName);
    setTeacherNameEn(cleanValues.teacherNameEn);
    setRoomNameTh(cleanValues.roomNameTh);
    setRoomNameEn(cleanValues.roomNameEn);
    setProperty(cleanValues.property);
    setNonProperty(cleanValues.nonProperty);
    setMidternDate(cleanValues.midternDate);
    setFinalDate(cleanValues.finalDate);
    setSectionStatus(cleanValues.sectionStatus);
      ...
      const record = idProp
        ? (
            await client.graphql({
              query: getSection.replaceAll("__typename", ""),
              variables: { id: idProp },
            })
          )?.data?.getSection
        : sectionModelProp;
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: updateSection.replaceAll("__typename", ""),
            variables: {
              input: {
                id: sectionRecord.id,
                ...modelFields,
