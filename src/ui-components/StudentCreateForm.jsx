...
export default function StudentCreateForm(props) {
  ...
  const resetStateValues = () => {
    setLoginName(initialValues.loginName);
    setStdId(initialValues.stdId);
    setStdCode(initialValues.stdCode);
    setTitleTh(initialValues.titleTh);
    setTitleEn(initialValues.titleEn);
    setFirstNameTh(initialValues.firstNameTh);
    setMiddleNameTh(initialValues.middleNameTh);
    setLastNameTh(initialValues.lastNameTh);
    setFirstNameEn(initialValues.firstNameEn);
    setMiddleNameEn(initialValues.middleNameEn);
    setLastNameEn(initialValues.lastNameEn);
    setCopenId(initialValues.copenId);
    setCopenNameTh(initialValues.copenNameTh);
    setCopenNameEn(initialValues.copenNameEn);
    setCampusCode(initialValues.campusCode);
    setCampusNameTh(initialValues.campusNameTh);
    setCampusNameEn(initialValues.campusNameEn);
    setFacultyCode(initialValues.facultyCode);
    setFacultyNameTh(initialValues.facultyNameTh);
    setFacultyNameEn(initialValues.facultyNameEn);
    setDepartmentCode(initialValues.departmentCode);
    setDepartmentNameTh(initialValues.departmentNameTh);
    setDepartmentNameEn(initialValues.departmentNameEn);
    setMajorCode(initialValues.majorCode);
    setMajorNameTh(initialValues.majorNameTh);
    setMajorNameEn(initialValues.majorNameEn);
    setNationCode(initialValues.nationCode);
    setNationalityNameTh(initialValues.nationalityNameTh);
    setNationalityNameEn(initialValues.nationalityNameEn);
    setStudentStatusCode(initialValues.studentStatusCode);
    setStudentStatusNameTh(initialValues.studentStatusNameTh);
    setStudentStatusNameEn(initialValues.studentStatusNameEn);
    setStudentTypeCode(initialValues.studentTypeCode);
    setStudentTypeNameTh(initialValues.studentTypeNameTh);
    setStudentTypeNameEn(initialValues.studentTypeNameEn);
    setEdulevelCode(initialValues.edulevelCode);
    setEdulevelNameTh(initialValues.edulevelNameTh);
    setEdulevelNameEn(initialValues.edulevelNameEn);
    setStudentYear(initialValues.studentYear);
    setAdvisorId(initialValues.advisorId);
    setAdvisorNameTh(initialValues.advisorNameTh);
    setAdvisorNameEn(initialValues.advisorNameEn);
    setPositionTh(initialValues.positionTh);
