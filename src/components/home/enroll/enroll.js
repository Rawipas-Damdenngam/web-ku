              ...
              <div style={{ height: 80 + "%" }}>
                ...
                <div className="ku-card" style={{ padding: 20 + "px" }}>
                  <div
                    ...
                    style={{ height: 50 + "px" }}
                  >
                    <div className="flex basis-full grow max-w-full items-center justify-center" style={{fontSize:14+"px"}}>
                      <i className="ku-outline-warning" style={{fontSize:32+"px"}}><AiOutlineInfoCircle/></i>
